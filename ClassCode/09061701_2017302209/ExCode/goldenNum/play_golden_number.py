...
if __name__ == '__main__':
    ...
    for index in range(1,400):
        ...
        g_num = round(0.618 * sum_num/len(_clients_dict),3)
        ...
        for name, client in _clients_dict.items():
            n1, n2 = client["h_numbers"][-1]
            abs_dis.append(round(abs(n1-g_num),3))
            abs_dis.append(round(abs(n2-g_num),3))
        ...
        for name, client in _clients_dict.items():
            n1, n2 = client["h_numbers"][-1]
            abs_dis1 = round(abs(n1-g_num),3)
            abs_dis2 = round(abs(n2-g_num),3)
